...
JSXが`chibireact/jsx-runtime`の呼び出しへ変換され、前章のElementになる経路を実装します。
...
```ts
import { jsx } from "chibireact/jsx-runtime";
...
本家Reactも`react/jsx-runtime`を公開します。chibireactでは開発用メタデータや所有者追跡を省き、変換の核だけを残します。

章の実装: [`book/impls/20-jsx`](https://github.com/beryu/chibireact/tree/main/book/impls/20-jsx)
