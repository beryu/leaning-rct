...
本家はpassive effectを専用phaseで処理し、Strict Modeの開発時検査も行います。leaning-rctはmicrotaskで一度実行する最小モデルです。

章の実装: [`book/impls/70-effects`](https://github.com/beryu/leaning-rct/tree/main/book/impls/70-effects)
